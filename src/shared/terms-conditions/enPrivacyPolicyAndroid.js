export default `
## **Helix Wallet App - Privacy Policy**

### **General Information**

This privacy policy ( **&quot;App Privacy Policy&quot;** ) describes how IOTA Foundation ( **&#39;&#39;IOTA &quot;**, **&#39;we&#39;**, **&#39;us&#39;**, **&#39;our&#39;**) collects, and process your Personal Data in connection with the usage of the **“Helix Wallet App”**.

This App Privacy Policy is dedicated to users of the Helix Wallet App. If you would like to know more about how IOTA processes Personal Data (as defined below) collected and processed in connection with other services and activities of IOTA, please see IOTA’s general [Privacy Policy](https://www.iota.org/research/privacy-policy).

Please read our App Privacy Policy carefully to get a clear understanding of how we handle your Personal Data when collected through the Helix Wallet App.
...
If you install and use the Helix Wallet App on your phone or other device, the IOTA Foundation may collect and process Personal Data required for the operation of the App and management and fulfilment of the App services.
...
We may collect information relating to the general use of the Helix Wallet App such as errors, log information concerning any errors encountered in the Helix Wallet App and other related information relevant to IOTA's provision of the services, for the purpose of administration and error analysis to help IOTA improve its services.

### **Purpose of processing of Personal Data**

We process the Personal Data in order to enable the operation and use of the Helix Wallet App as well as for the administration and management of the Helix Wallet App and the services offered via it.
...
We do not use cookies in the Helix Wallet App.
...
In order to properly operate the Helix Wallet App and to be able to provide you the services offered via the Helix Wallet App, we use the following analytics software during the operation of the App:

#### **Bugsnag**

We use Bugsnag of Bugsnag Inc., 939 Harrison St, San Francisco, CA 94107, USA (“Bugsnag”) to collect crash and error logs that occur while a user is using the app. When an error occurs the unique identifier in an anonymized form and information about your settings will be transferred to Bugsnag. Further information you can find under [http://docs.bugsnag.com/legal/privacy-policy](http://docs.bugsnag.com/legal/privacy-policy).

#### **CryptoCompare**

We use CryptoCompare API of Crypto Coin Comparison Limited, 162 Main Road, Danbury, Chelmsford, England CM3 4DT ("CryptoCompare") to obtain historical price and market data for cryptocurrencies. Further information regarding their privacy policy can be found under [https://www.cryptocompare.com/privacy-policy/](https://protect-eu.mimecast.com/s/jjoIC868JFzJklpSnZWeH?domain=cryptocompare.com)

#### **GitHub**

We use GitHub of GitHub Inc 88 Colin P. Kelly Street, San Francisco, CA 94107, USA (“GitHub” - in the European Union: GitHub BV Vijzelstraat 68-72, 1017 HL Amsterdam, The Netherlands) to check for app updates in order to provide the auto-update functionality. Further information regarding their privacy policy can be found under [https://help.github.com/articles/github-privacy-statement/](https://protect-eu.mimecast.com/s/pbXoCmQR3FA0MZNH3GMUB?domain=help.github.com).
...
We use various websites to check your connection to the internet while using Helix. Helix Desktop may contact GitHub to check for app updates in order to provide the auto-update functionality. When accessing these websites, your data is handled in accordance with their respective privacy policies. If Helix cannot connect to a website, it will attempt to connect to the next website in the list. The check is conducted in the following order:

- IOTA Foundation, [iota.org](https://protect-eu.mimecast.com/s/MO_jC9Q6KFMZOvEfE_FMu?domain=iota.org) ([https://www.iota.org/research/privacy-policy](https://protect-eu.mimecast.com/s/imFzC0VqxFMEyKwf2zX68?domain=iota.org))

- Google Inc, [google.com](https://protect-eu.mimecast.com/s/QlxOCgLY3FmgBrZU366z0?domain=google.com) ([https://policies.google.com/privacy](https://protect-eu.mimecast.com/s/szfkCjqQ3C36O2Qf1qmQ8?domain=policies.google.com))

- Sogou Inc, [sogou.com](https://protect-eu.mimecast.com/s/0HEQCkZQ3IrLw7zF8XX2w?domain=sogou.com) ([https://corp.sogou.com/private.html](https://protect-eu.mimecast.com/s/7IRACl5Q3IA9MyNHVEzuy?domain=corp.sogou.com))

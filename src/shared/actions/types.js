...
export const AccountsActionTypes = {
  UPDATE_ADDRESSES: "HELIX/ACCOUNTS/UPDATE_ADDRESSES",
  UPDATE_ACCOUNT_INFO_AFTER_SPENDING:
    "HELIX/ACCOUNTS/UPDATE_ACCOUNT_INFO_AFTER_SPENDING",
  UPDATE_ACCOUNT_AFTER_REATTACHMENT:
    "HELIX/ACCOUNTS/UPDATE_ACCOUNT_AFTER_REATTACHMENT",
  ...
  UPDATE_ACCOUNT_AFTER_TRANSITION:
    "HELIX/ACCOUNTS/UPDATE_ACCOUNT_AFTER_TRANSITION",
  FULL_ACCOUNT_INFO_FETCH_REQUEST:
    "HELIX/ACCOUNTS/FULL_ACCOUNT_INFO_FETCH_REQUEST",
  FULL_ACCOUNT_INFO_FETCH_SUCCESS:
    "HELIX/ACCOUNTS/FULL_ACCOUNT_INFO_FETCH_SUCCESS",
  ...
  SYNC_ACCOUNT_BEFORE_MANUAL_PROMOTION:
    "HELIX/ACCOUNTS/SYNC_ACCOUNT_BEFORE_MANUAL_PROMOTION",
...
export const KeychainActionTypes = {
  IS_GETTING_SENSITIVE_INFO_REQUEST:
    "HELIX/KEYCHAIN/IS_GETTING_SENSITIVE_INFO_REQUEST",
  IS_GETTING_SENSITIVE_INFO_SUCCESS:
    "HELIX/KEYCHAIN/IS_GETTING_SENSITIVE_INFO_SUCCESS",
  IS_GETTING_SENSITIVE_INFO_ERROR:
    "HELIX/KEYCHAIN/IS_GETTING_SENSITIVE_INFO_ERROR"
};
...
export const PollingActionTypes = {
  ...
  ACCOUNT_INFO_FOR_ALL_ACCOUNTS_FETCH_REQUEST:
    "HELIX/POLLING/ACCOUNT_INFO_FOR_ALL_ACCOUNTS_FETCH_REQUEST",
  ACCOUNT_INFO_FOR_ALL_ACCOUNTS_FETCH_SUCCESS:
    "HELIX/POLLING/ACCOUNT_INFO_FOR_ALL_ACCOUNTS_FETCH_SUCCESS",
  ACCOUNT_INFO_FOR_ALL_ACCOUNTS_FETCH_ERROR:
    "HELIX/POLLING/ACCOUNT_INFO_FOR_ALL_ACCOUNTS_FETCH_ERROR",
  ...
  SYNC_ACCOUNT_BEFORE_AUTO_PROMOTION:
    "HELIX/POLLING/SYNC_ACCOUNT_BEFORE_AUTO_PROMOTION",
...
export const SettingsActionTypes = {
  ...
  CURRENCY_DATA_UPDATE: "HELIX/SETTINGS/CURRENCY_DATA_UPDATE",
  ...
  SET_COMPLETED_FORCED_PASSWORD_UPDATE:
    "HELIX/SETTINGS/SET_COMPLETED_FORCED_PASSWORD_UPDATE",
  ...
  UPDATE_NODE_AUTO_SWITCH_SETTING:
    "HELIX/SETTINGS/UPDATE_NODE_AUTO_SWITCH_SETTING",
...
export const TransfersActionTypes = {
  ...
  RETRY_FAILED_TRANSACTION_REQUEST:
    "HELIX/TRANSFERS/RETRY_FAILED_TRANSACTION_REQUEST",
  RETRY_FAILED_TRANSACTION_SUCCESS:
    "HELIX/TRANSFERS/RETRY_FAILED_TRANSACTION_SUCCESS",
  RETRY_FAILED_TRANSACTION_ERROR:
    "HELIX/TRANSFERS/RETRY_FAILED_TRANSACTION_ERROR"
};
...
export const WalletActionTypes = {
  ...
  SNAPSHOT_ATTACH_TO_TANGLE_REQUEST:
    "HELIX/WALLET/SNAPSHOT_ATTACH_TO_TANGLE_REQUEST",
  SNAPSHOT_ATTACH_TO_TANGLE_COMPLETE:
    "HELIX/WALLET/SNAPSHOT_ATTACH_TO_TANGLE_COMPLETE",

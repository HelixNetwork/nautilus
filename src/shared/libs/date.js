...
export const isToday = (day, timezone) =>
  moment.tz(timezone).isSame(moment(day), "day");
...
export const isMinutesAgo = (time, timezone, minutes) => {
  return moment
    .tz(time, timezone)
    .isBefore(moment().subtract(minutes, "minutes"));
};

export const isValid = (dateString, format = "YYYY MMM DD") =>
...
export const convertUnixTimeToJSDate = time =>
  convertUnixTimeToDateObject(time);

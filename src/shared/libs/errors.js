export default {
  CANNOT_TRANSITION_ADDRESSES_WITH_ZERO_BALANCE:
    "Cannot transition addresses with zero balance.",
  ...
  INVALID_BUNDLE_CONSTRUCTED_WITH_REMOTE_POW:
    "Invalid bundle constructed with remote proof-of-work.",
  INVALID_BUNDLE_CONSTRUCTED_WITH_LOCAL_POW:
    "Invalid bundle constructed with local proof-of-work.",
  ...
  SOMETHING_WENT_WRONG_DURING_INPUT_SELECTION:
    "Something went wrong during input selection.",
  ...
  INVALID_LAST_BIT: "Last txBit from the address is not 0",
  ...
  CANNOT_FIND_INPUTS_WITH_PROVIDED_LIMIT:
    "Cannot find inputs with provided limit.",
  ...
  MAX_INPUTS_EXCEEDED: (count, max) =>
    `Can't process transactions with ${count} inputs. The limit is ${max}.`,

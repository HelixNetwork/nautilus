...
//             addresses = Array(15)
//                 .fill()
//                 .map((_, i) => String.fromCharCode(selectChar(i)).repeat(64));
...
//                 return addressesUtils
//                     .getAddressDataUptoRemainder()(mockAddressData, [], seedStore, [f, 'I'.repeat(64)])
...
//         before(() => {
//             addresses = map(['U', 'A', 'S', '9'], (char) => char.repeat(64));
//         });

...
let language = {
    ...
    updates: {
        ...
        noUpdatesAvailableExplanation: `You have the latest version of ${app.getName()}!`,
        newVersionAvailable: 'New version available',
        newVersionAvailableExplanation: `A new ${app.getName()} version is available. Do you want to update now?`,

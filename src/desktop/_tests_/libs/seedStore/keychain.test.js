...
import Keychain from 'src/libs/seed/Keychain';
import { passwordMock, vaultMock, seedTxsMock, seedBytesMock } from '../../../__mocks__/samples/keychain';
...
describe('Keychain SeedStore class', () => {
    ...
    test('Get seed in trytes form', async () => {
        ...
        expect(seed).toEqual(seedTxsMock);
    });
    ...
    test('Generate address and call garbage collector', async () => {
        ...
        expect(genFn).toBeCalledWith(seedTxsMock, 1, 2, 1);

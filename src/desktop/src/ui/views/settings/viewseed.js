          ...
          <div className={classNames(css.set_bxac)}>
            ...
            {typeof accountMeta.index === "number" && (
              <Fragment>
                ...
                <p>
                  ...
                  <strong>
                    {(accountMeta.index = null ? " " : accountMeta)}
                  </strong>
                </p>
              </Fragment>
            )}
            {typeof accountMeta.page === "number" && accountMeta.page > 0 && (
              <Fragment>
                ...
                <p>
                  <hr />
                  {t("viewSeed:accountPage")}:{" "}
                  <strong>{accountMeta.page}</strong>
                </p>
              </Fragment>
            )}
          </div>
          ...
          <form>
            ...
            <div style={{ marginTop: "12vw" }}>
              <Button
                className="navleft"
                onClick={() =>
                  this.setState({ action: action !== "view" ? "view" : null })
                }
              >
              ...
              <Button
                className="navright"
                onClick={() => this.setState({ action: "export" })}
              >
                {t("seedVault:exportSeedVault")}
              </Button>
            </div>

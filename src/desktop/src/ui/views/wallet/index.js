                            ...
                            <div className="row">
                                <div className={classNames(css.sseed_box1, css.cre_pgs)}>
                                    ...
                                    <div className={classNames(css.icon_secs1)}>
                                        <div onClick={() => history.push('/wallet/send')} className={(classNames(css.img_sr, css.img_sr_imgss1))}><img src={ic1} className={classNames(css.img)} alt="" /><h2 className={classNames(css.img_sr_h2)}>Send <span>></span></h2></div>
                                        <div onClick={() => history.push('/wallet/receive')} className={(classNames(css.img_sr, css.img_sr_imgss2))}><img src={ic2} className={classNames(css.img)} alt="" /><h2 className={classNames(css.img_sr_h2)}>Receive <span>></span></h2></div>
                                        <div className={(classNames(css.img_sr, css.img_sr_imgss3))}><img src={ic3} className={classNames(css.img)} alt="" /><h2 className={classNames(css.img_sr_h2)}>Chart <span>></span></h2></div>
                                        <div className={(classNames(css.img_sr, css.img_sr_imgss4))}><img src={ic4} className={classNames(css.img)} alt="" /><h2 className={classNames(css.img_sr_h2)}>History <span>></span></h2></div>
                                        <div className={(classNames(css.img_sr, css.img_sr_imgss5))}><img src={ic5} className={classNames(css.img)} alt="" /><h2 className={classNames(css.img_sr_h2)}>Address Book <span>></span></h2></div>
                                    </div>
                                </div>

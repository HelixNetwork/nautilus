...
export class ListComponent extends React.PureComponent {
    ...
    render() {
        const { mode, hideEmptyTransactions, setItem, currentItem, t } = this.props;

        const { filter, currentlyPromotingBundleHash, isRetryingFailedTransaction, transactions, search } = this.state;
            ...
            <React.Fragment>
                <nav className={css.nav}>
                    <div className={css.search}>
                        <div onClick={() => this.setState({ search: '' })} className={css.search_icon_style}>
                            ...
                            <div className={css.sent}>
                                <p>
                                    <strong>
                                        ...
                                        <span>{formatHlx(activeTx.transferValue, false, true)}</span>
                                    </strong>
                                    <small>

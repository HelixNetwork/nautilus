        ...
        if (typeof error === 'string' && error.indexOf('Unknown or unsupported transport') > -1) {
            return (
                <form>
                    ...
                    <p>
                        Please check that you are not running Nautilus as <strong>root</strong> user
        ...
        if (
            ...
            return (
                <form>
                    ...
                    <p>
                        The database Nautilus uses (Realm) is currently incompatible with Windows OS usernames that
        ...
        if (
            ...
            return (
                <form className={css.tutorial}>
                    ...
                    <p>
                        Your Linux distribution is missing libsecret library that is required for Nautilus to securely

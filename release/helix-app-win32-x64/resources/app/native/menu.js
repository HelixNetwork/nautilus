...
let language = {
    ...
    updates: {
        ...
        newVersionAvailableExplanation: 'A new Helix version is available. Do you want to update now?',
        installUpdate: 'Install update and restart',
        installUpdateExplanation: 'Download complete, Helix will now restart to install the update',
    },
};
